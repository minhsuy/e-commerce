...
import { adminSidebar } from '../../utils/extraInfomation'
import { Link, NavLink } from 'react-router-dom';
import { icons } from '../../utils/icons';
const activedStyle = 'flex items-center gap-x-4 p-2 rounded-md hover:bg-blue-500 hover:text-white'
const notActivedStyle = 'px-4 py-2 flex items-center gap-2'
    ...
    return (
        <div className='py-4 h-full bg-slate-100 p-3 '>
            <div className='flex flex-col items-center justify-center gap-2'>
                ...
                <span className='text-base font-medium mt-4'>Admin WorkSpace</span>
            </div>
